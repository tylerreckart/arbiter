...
| `layout` | Padding, column breakpoints, vertical rhythm (`block_gap`, `panel_gap`, `prose_paragraph_gap`), chrome density (`chrome_compact_rows`, `scroll_pad_y`, `scroll_gutter_cols`), `show_footer`, `show_history_sidebar`, … |
