...
inline constexpr const char* kBoxJoinL = "\u251C";     // ├
inline constexpr const char* kBoxJoinR = "\u2524";     // ┤
...
// Interior divider that meets the box's vertical sides (`├─ Title ─┤`).
inline void draw_box_divider_row(OpenTuiHandle frame,
                                 int x,
                                 int y,
                                 int w,
                                 const TuiRgba& border_fg,
