...
static std::string index_ai_prompt(Brevity level) {
    ...
    base +=
        ...
        "  /mem search <query>           — substring search across curated entries\n"
        "  /mem propose entry <type> <title>            — propose a new typed graph node\n"
        "                                  (types: user, feedback, project, reference,\n"
        "                                   learning, context).  Lands in the review queue;\n"
        "                                   not visible until a human accepts it.\n"
